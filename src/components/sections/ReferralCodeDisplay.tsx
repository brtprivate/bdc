          ...
          <Card
            sx={{
              ...
              "&::before": {
                ...
                height: "6px",
                background:
                  "linear-gradient(90deg, #ff9800, #ffb74d, #ff6f00, #ff9800)",
            ...
            <CardContent sx={{ p: 4 }}>
              <Box display="flex" alignItems="center" mb={3}>
                ...
                <Box>
                  ...
                  <Typography
                    variant="body1"
                    sx={{ color: "#ff9800", fontWeight: "medium" }}
                  >
              ...
              >
                <Typography
                  variant="body2"
                  sx={{ color: "#ff9800", mb: 1, fontWeight: "bold" }}
                >
              ...
              >
                <Typography variant="body2">
                  <strong>Important:</strong> This address is automatically used
                  when users register without a specific referral link. All
                  commissions from these registrations go to the USDStack
                  platform.
                </Typography>
              </Alert>
            </CardContent>
              ...
              <CardContent sx={{ p: 3 }}>
                <Box display="flex" alignItems="center" mb={2}>
                  <Group
                    sx={{
                      mr: 2,
                      color: mlm.isMLMRegistered ? "#4caf50" : "#666",
                      fontSize: 32,
                    }}
                  />
                  <Box>
                ...
                {mlm.isMLMRegistered && wallet.account ? (
                  <>
                    <TextField
                      ...
                      InputProps={{
                        ...
                        endAdornment: (
                          <Tooltip
                            title={copied ? "Copied!" : "Copy Your Code"}
                          >
                            <IconButton
                              onClick={handleCopyAddress}
                              sx={{ color: "#4caf50" }}
                  ...
                  >
                    Please register for the platform to get your personal
                    referral code.
                  </Alert>
                )}
              </CardContent>
              ...
              <CardContent>
                ...
                <TextField
                  ...
                  InputProps={{
                    ...
                    endAdornment: (
                      <Tooltip
                        title={linkCopied ? "Copied!" : "Copy Referral Link"}
                      >
                        <IconButton
                          onClick={handleCopyLink}
                          sx={{ color: "#4caf50" }}
                ...
                <Typography variant="body2" sx={{ color: "#b0b0b0", mt: 1 }}>
                  Share this link with others to earn referral commissions when
                  they join and invest.
                </Typography>
              </CardContent>
            </Card>
          </Box>
